; ModuleID = 'matrixmultiply_t.prelto.linked.bc'
...
define i32 @multiply(i32 %i, i32 %j) #0 {
  %1 = getelementptr inbounds [20 x [20 x i32]]* @A1, i32 0, i32 %i, i32 0
  %2 = load i32* %1, align 4, !tbaa !1
  %3 = getelementptr inbounds [20 x [20 x i32]]* @B1, i32 0, i32 0, i32 %j
  %4 = load i32* %3, align 4, !tbaa !1
  %5 = mul nsw i32 %4, %2
  %6 = getelementptr inbounds [20 x [20 x i32]]* @A1, i32 0, i32 %i, i32 1
  %7 = load i32* %6, align 4, !tbaa !1
  %8 = getelementptr inbounds [20 x [20 x i32]]* @B1, i32 0, i32 1, i32 %j
  %9 = load i32* %8, align 4, !tbaa !1
  %10 = mul nsw i32 %9, %7
  %11 = add nsw i32 %5, %10
  %12 = getelementptr inbounds [20 x [20 x i32]]* @A1, i32 0, i32 %i, i32 2
  %13 = load i32* %12, align 4, !tbaa !1
  %14 = getelementptr inbounds [20 x [20 x i32]]* @B1, i32 0, i32 2, i32 %j
  %15 = load i32* %14, align 4, !tbaa !1
  %16 = mul nsw i32 %15, %13
  %17 = add nsw i32 %11, %16
  %18 = getelementptr inbounds [20 x [20 x i32]]* @A1, i32 0, i32 %i, i32 3
  %19 = load i32* %18, align 4, !tbaa !1
  %20 = getelementptr inbounds [20 x [20 x i32]]* @B1, i32 0, i32 3, i32 %j
  %21 = load i32* %20, align 4, !tbaa !1
  %22 = mul nsw i32 %21, %19
  %23 = add nsw i32 %17, %22
  %24 = getelementptr inbounds [20 x [20 x i32]]* @A1, i32 0, i32 %i, i32 4
  %25 = load i32* %24, align 4, !tbaa !1
  %26 = getelementptr inbounds [20 x [20 x i32]]* @B1, i32 0, i32 4, i32 %j
  %27 = load i32* %26, align 4, !tbaa !1
  %28 = mul nsw i32 %27, %25
  %29 = add nsw i32 %28, %23
  %30 = getelementptr inbounds [20 x [20 x i32]]* @A1, i32 0, i32 %i, i32 5
  %31 = load i32* %30, align 4, !tbaa !1
  %32 = getelementptr inbounds [20 x [20 x i32]]* @B1, i32 0, i32 5, i32 %j
  %33 = load i32* %32, align 4, !tbaa !1
  %34 = mul nsw i32 %33, %31
  %35 = add nsw i32 %29, %34
  %36 = getelementptr inbounds [20 x [20 x i32]]* @A1, i32 0, i32 %i, i32 6
  %37 = load i32* %36, align 4, !tbaa !1
  %38 = getelementptr inbounds [20 x [20 x i32]]* @B1, i32 0, i32 6, i32 %j
  %39 = load i32* %38, align 4, !tbaa !1
  %40 = mul nsw i32 %39, %37
  %41 = add nsw i32 %35, %40
  %42 = getelementptr inbounds [20 x [20 x i32]]* @A1, i32 0, i32 %i, i32 7
  %43 = load i32* %42, align 4, !tbaa !1
  %44 = getelementptr inbounds [20 x [20 x i32]]* @B1, i32 0, i32 7, i32 %j
  %45 = load i32* %44, align 4, !tbaa !1
  %46 = mul nsw i32 %45, %43
  %47 = add nsw i32 %41, %46
  %48 = getelementptr inbounds [20 x [20 x i32]]* @A1, i32 0, i32 %i, i32 8
  %49 = load i32* %48, align 4, !tbaa !1
  %50 = getelementptr inbounds [20 x [20 x i32]]* @B1, i32 0, i32 8, i32 %j
  %51 = load i32* %50, align 4, !tbaa !1
  %52 = mul nsw i32 %51, %49
  %53 = add nsw i32 %52, %47
  %54 = getelementptr inbounds [20 x [20 x i32]]* @A1, i32 0, i32 %i, i32 9
  %55 = load i32* %54, align 4, !tbaa !1
  %56 = getelementptr inbounds [20 x [20 x i32]]* @B1, i32 0, i32 9, i32 %j
  %57 = load i32* %56, align 4, !tbaa !1
  %58 = mul nsw i32 %57, %55
  %59 = add nsw i32 %53, %58
  %60 = getelementptr inbounds [20 x [20 x i32]]* @A1, i32 0, i32 %i, i32 10
  %61 = load i32* %60, align 4, !tbaa !1
  %62 = getelementptr inbounds [20 x [20 x i32]]* @B1, i32 0, i32 10, i32 %j
  %63 = load i32* %62, align 4, !tbaa !1
  %64 = mul nsw i32 %63, %61
  %65 = add nsw i32 %59, %64
  %66 = getelementptr inbounds [20 x [20 x i32]]* @A1, i32 0, i32 %i, i32 11
  %67 = load i32* %66, align 4, !tbaa !1
  %68 = getelementptr inbounds [20 x [20 x i32]]* @B1, i32 0, i32 11, i32 %j
  %69 = load i32* %68, align 4, !tbaa !1
  %70 = mul nsw i32 %69, %67
  %71 = add nsw i32 %65, %70
  %72 = getelementptr inbounds [20 x [20 x i32]]* @A1, i32 0, i32 %i, i32 12
  %73 = load i32* %72, align 4, !tbaa !1
  %74 = getelementptr inbounds [20 x [20 x i32]]* @B1, i32 0, i32 12, i32 %j
  %75 = load i32* %74, align 4, !tbaa !1
  %76 = mul nsw i32 %75, %73
  %77 = add nsw i32 %76, %71
  %78 = getelementptr inbounds [20 x [20 x i32]]* @A1, i32 0, i32 %i, i32 13
  %79 = load i32* %78, align 4, !tbaa !1
  %80 = getelementptr inbounds [20 x [20 x i32]]* @B1, i32 0, i32 13, i32 %j
  %81 = load i32* %80, align 4, !tbaa !1
  %82 = mul nsw i32 %81, %79
  %83 = add nsw i32 %77, %82
  %84 = getelementptr inbounds [20 x [20 x i32]]* @A1, i32 0, i32 %i, i32 14
  %85 = load i32* %84, align 4, !tbaa !1
  %86 = getelementptr inbounds [20 x [20 x i32]]* @B1, i32 0, i32 14, i32 %j
  %87 = load i32* %86, align 4, !tbaa !1
  %88 = mul nsw i32 %87, %85
  %89 = add nsw i32 %83, %88
  %90 = getelementptr inbounds [20 x [20 x i32]]* @A1, i32 0, i32 %i, i32 15
  %91 = load i32* %90, align 4, !tbaa !1
  %92 = getelementptr inbounds [20 x [20 x i32]]* @B1, i32 0, i32 15, i32 %j
  %93 = load i32* %92, align 4, !tbaa !1
  %94 = mul nsw i32 %93, %91
  %95 = add nsw i32 %89, %94
  %96 = getelementptr inbounds [20 x [20 x i32]]* @A1, i32 0, i32 %i, i32 16
  %97 = load i32* %96, align 4, !tbaa !1
  %98 = getelementptr inbounds [20 x [20 x i32]]* @B1, i32 0, i32 16, i32 %j
  %99 = load i32* %98, align 4, !tbaa !1
  %100 = mul nsw i32 %99, %97
  %101 = add nsw i32 %100, %95
  %102 = getelementptr inbounds [20 x [20 x i32]]* @A1, i32 0, i32 %i, i32 17
  %103 = load i32* %102, align 4, !tbaa !1
  %104 = getelementptr inbounds [20 x [20 x i32]]* @B1, i32 0, i32 17, i32 %j
  %105 = load i32* %104, align 4, !tbaa !1
  %106 = mul nsw i32 %105, %103
  %107 = add nsw i32 %101, %106
  %108 = getelementptr inbounds [20 x [20 x i32]]* @A1, i32 0, i32 %i, i32 18
  %109 = load i32* %108, align 4, !tbaa !1
  %110 = getelementptr inbounds [20 x [20 x i32]]* @B1, i32 0, i32 18, i32 %j
  %111 = load i32* %110, align 4, !tbaa !1
  %112 = mul nsw i32 %111, %109
  %113 = add nsw i32 %107, %112
  %114 = getelementptr inbounds [20 x [20 x i32]]* @A1, i32 0, i32 %i, i32 19
  %115 = load i32* %114, align 4, !tbaa !1
  %116 = getelementptr inbounds [20 x [20 x i32]]* @B1, i32 0, i32 19, i32 %j
  %117 = load i32* %116, align 4, !tbaa !1
  %118 = mul nsw i32 %117, %115
  %119 = add nsw i32 %113, %118
  %120 = getelementptr inbounds [20 x [20 x i32]]* @resultAB1, i32 0, i32 %i, i32 %j
...
.preheader:                                       ; preds = %6, %0
  %count.04 = phi i64 [ 0, %0 ], [ %.lcssa, %6 ]
  %i.03 = phi i32 [ 0, %0 ], [ %7, %6 ]
  br label %1

; <label>:1                                       ; preds = %1, %.preheader
  %count.12 = phi i64 [ %count.04, %.preheader ], [ %4, %1 ]
  %j.01 = phi i32 [ 0, %.preheader ], [ %5, %1 ]
  %2 = tail call i32 @multiply(i32 %i.03, i32 %j.01) #2
  %3 = sext i32 %2 to i64
  %4 = add i64 %3, %count.12
  %5 = add nsw i32 %j.01, 1
  %exitcond = icmp eq i32 %5, 20
  br i1 %exitcond, label %6, label %1

; <label>:6                                       ; preds = %1
  %.lcssa = phi i64 [ %4, %1 ]
  %7 = add nsw i32 %i.03, 1
  %exitcond5 = icmp eq i32 %7, 20
  br i1 %exitcond5, label %8, label %.preheader

; <label>:8                                       ; preds = %6
  %.lcssa.lcssa = phi i64 [ %.lcssa, %6 ]
  %9 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str, i32 0, i32 0), i64 %.lcssa.lcssa) #3
  %10 = icmp eq i64 %.lcssa.lcssa, 962122000
  br i1 %10, label %11, label %13

; <label>:11                                      ; preds = %8
  %12 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str1, i32 0, i32 0)) #3
  br label %15

; <label>:13                                      ; preds = %8
  %14 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str2, i32 0, i32 0)) #3
  br label %15

; <label>:15                                      ; preds = %13, %11
  %16 = trunc i64 %.lcssa.lcssa to i32
  ret i32 %16
}
