; ModuleID = 'matrixmultiply_t.1.bc'
...
.preheader:                                       ; preds = %84, %0
  %count.04 = phi i64 [ 0, %0 ], [ %.lcssa, %84 ]
...
; <label>:21                                      ; preds = %21, %.preheader
  ...
  br i1 %exitcond1, label %84, label %21
...
; <label>:86                                      ; preds = %84
  %.lcssa.lcssa = phi i64 [ %.lcssa, %84 ]
  %87 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str, i32 0, i32 0), i64 %.lcssa.lcssa) #1
  %88 = icmp eq i64 %.lcssa.lcssa, 962122000
...
; <label>:93                                      ; preds = %91, %89
  %94 = trunc i64 %.lcssa.lcssa to i32
  ret i32 %94
}
