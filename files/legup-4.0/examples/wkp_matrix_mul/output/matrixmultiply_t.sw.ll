; ModuleID = 'output/matrixmultiply_t.sw.bc'
...
; <label>:126                                     ; preds = %124
  ...
  %127 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str, i32 0, i32 0), i64 %.lcssa.lcssa)
  %128 = icmp eq i64 %.lcssa.lcssa, 962122000
  br i1 %128, label %129, label %131

; <label>:129                                     ; preds = %126
  %130 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str1, i32 0, i32 0))
  br label %133

; <label>:131                                     ; preds = %126
  %132 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str2, i32 0, i32 0))
  br label %133
