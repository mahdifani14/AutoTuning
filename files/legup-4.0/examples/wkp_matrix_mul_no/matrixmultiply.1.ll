...
.preheader1:                                      ; preds = %10, %0
  %count.05 = phi i64 [ 0, %0 ], [ %.lcssa2, %10 ]
...
multiply.exit:                                    ; preds = %1
  %.lcssa = phi i32 [ %5, %1 ]
  store volatile i32 %.lcssa, i32* %scevgep5, align 4, !tbaa !1
...
; <label>:10                                      ; preds = %multiply.exit
  %.lcssa2 = phi i64 [ %8, %multiply.exit ]
  %11 = add nsw i32 %i.04, 1
  %exitcond = icmp eq i32 %11, 20
  br i1 %exitcond, label %12, label %.preheader1

; <label>:12                                      ; preds = %10
  %.lcssa2.lcssa = phi i64 [ %.lcssa2, %10 ]
  %13 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str, i32 0, i32 0), i64 %.lcssa2.lcssa) #1
  %14 = icmp eq i64 %.lcssa2.lcssa, 962122000
...
; <label>:19                                      ; preds = %17, %15
  %20 = trunc i64 %.lcssa2.lcssa to i32
  ret i32 %20
}
