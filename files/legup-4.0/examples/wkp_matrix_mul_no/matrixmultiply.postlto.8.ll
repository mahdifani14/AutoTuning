; ModuleID = 'matrixmultiply.postlto.8.bc'
...
; <label>:15                                      ; preds = %13
  ...
  %16 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str, i32 0, i32 0), i64 %.lcssa1.lcssa) #1
  %17 = icmp eq i64 %.lcssa1.lcssa, 962122000
  br i1 %17, label %18, label %20

; <label>:18                                      ; preds = %15
  %19 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str1, i32 0, i32 0)) #1
  br label %22

; <label>:20                                      ; preds = %15
  %21 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str2, i32 0, i32 0)) #1
  br label %22
