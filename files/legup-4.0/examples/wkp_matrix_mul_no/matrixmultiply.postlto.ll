; ModuleID = 'matrixmultiply.postlto.bc'
...
.preheader1:                                      ; preds = %13, %0
  %count.05 = phi i64 [ 0, %0 ], [ %.lcssa2, %13 ]
...
; <label>:13                                      ; preds = %multiply.exit
  %.lcssa2 = phi i64 [ %11, %multiply.exit ]
  %14 = add nsw i32 %i.04, 1
  %exitcond7 = icmp eq i32 %14, 20
  br i1 %exitcond7, label %15, label %.preheader1

; <label>:15                                      ; preds = %13
  %.lcssa2.lcssa = phi i64 [ %.lcssa2, %13 ]
  %16 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str, i32 0, i32 0), i64 %.lcssa2.lcssa) #1
  %17 = icmp eq i64 %.lcssa2.lcssa, 962122000
...
; <label>:22                                      ; preds = %20, %18
  %23 = trunc i64 %.lcssa2.lcssa to i32
  ret i32 %23
}
