...
.preheader1:                                      ; preds = %13, %0
  %count.05 = phi i64 [ 0, %0 ], [ %.lcssa1, %13 ]
...
; <label>:1                                       ; preds = %1, %.preheader
  ...
  %3 = volatile load i32* %2, align 4, !tbaa !1
  %4 = getelementptr inbounds [20 x [20 x i32]]* @B1, i32 0, i32 %k.01.i, i32 %j.02
  %5 = volatile load i32* %4, align 4, !tbaa !1
  %6 = mul nsw i32 %5, %3
...
multiply.exit:                                    ; preds = %1
  ...
  volatile store i32 %.lcssa, i32* %9, align 4, !tbaa !1
...
; <label>:13                                      ; preds = %multiply.exit
  %.lcssa1 = phi i64 [ %11, %multiply.exit ]
  %14 = add nsw i32 %i.04, 1
  %exitcond7 = icmp eq i32 %14, 20
  br i1 %exitcond7, label %15, label %.preheader1

; <label>:15                                      ; preds = %13
  %.lcssa1.lcssa = phi i64 [ %.lcssa1, %13 ]
  %16 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str, i32 0, i32 0), i64 %.lcssa1.lcssa)
  %17 = icmp eq i64 %.lcssa1.lcssa, 962122000
  br i1 %17, label %18, label %20

; <label>:18                                      ; preds = %15
  %19 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str1, i32 0, i32 0))
  br label %22

; <label>:20                                      ; preds = %15
  %21 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str2, i32 0, i32 0))
  br label %22

; <label>:22                                      ; preds = %20, %18
  %23 = trunc i64 %.lcssa1.lcssa to i32
  ret i32 %23
}
