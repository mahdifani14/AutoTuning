...
sort.exit:                                        ; preds = %sort.exit, %.loopexit12.i
  ...
  %852 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str, i32 0, i32 0), i32 %851)
  %853 = add nsw i32 %i.02, 1
  %exitcond3 = icmp eq i32 %853, 100
  br i1 %exitcond3, label %854, label %sort.exit

; <label>:854                                     ; preds = %sort.exit
  %855 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([15 x i8]* @.str1, i32 0, i32 0))
  br label %856
...
; <label>:856                                     ; preds = %856, %854
  ...
  %859 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str, i32 0, i32 0), i32 %858)
