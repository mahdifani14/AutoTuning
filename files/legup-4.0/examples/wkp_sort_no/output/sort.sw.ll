...
sort.exit:                                        ; preds = %sort.exit, %.loopexit.i
  ...
  %23 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str, i32 0, i32 0), i32 %22)
  %24 = add nsw i32 %i.02, 1
  %exitcond6 = icmp eq i32 %24, 100
  br i1 %exitcond6, label %25, label %sort.exit

; <label>:25                                      ; preds = %sort.exit
  %26 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([15 x i8]* @.str1, i32 0, i32 0))
  br label %27
...
; <label>:27                                      ; preds = %27, %25
  ...
  %30 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str, i32 0, i32 0), i32 %29)
